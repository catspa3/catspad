...
import (
	...
	"github.com/catspa3/go-secp256k1"
	"github.com/catspa3/catspad/cmd/kaspawallet/daemon/client"
	"github.com/catspa3/catspad/cmd/kaspawallet/daemon/pb"
	"github.com/catspa3/catspad/cmd/kaspawallet/libkaspawallet"
	"github.com/catspa3/catspad/cmd/kaspawallet/libkaspawallet/serialization"
	...
	"github.com/catspa3/catspad/domain/consensus/utils/txscript"
	"github.com/catspa3/catspad/domain/consensus/utils/utxo"
...
func sweep(conf *sweepConfig) error {
	...
	for i, txID := range response.TxIDs {
		fmt.Printf("\t%s\n", txID)
		fmt.Println("\tSwept:\t", utils.FormatKas(splitTransactions[i].Outputs[0].Value), " CATSPA")
		totalExtracted = totalExtracted + splitTransactions[i].Outputs[0].Value
	}

	fmt.Println("\nTotal Funds swept (including transaction fees):")
	fmt.Println("\t", utils.FormatKas(totalExtracted), " CATSPA")
